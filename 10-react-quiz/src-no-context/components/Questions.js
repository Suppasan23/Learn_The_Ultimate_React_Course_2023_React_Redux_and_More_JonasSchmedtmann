...
function Questions({index, currentQuestion, numQuestions, choosing, dispatch}){
    ...
    return(
        <>
            <div>
                ...
                <div>
                    {(choosing !== null) && <NextButton index={index} numQuestions={numQuestions} dispatch={dispatch}/>}
                </div>
