...
function Formm() {
  ...
  const { createBookingCity, isLoading } = CitiesContext_Using();
  ...
  async function handleSubmit(e){
    ...
    await createBookingCity(newCity);
    navigate("/app/cities");
  }
  ...
  return (
    <>
      <p>Latituse=${lat}<br/>Lontitude=${lng}</p>

      <form className={`${styles.formm} ${isLoading && styles.loading}`} onSubmit={handleSubmit}>
